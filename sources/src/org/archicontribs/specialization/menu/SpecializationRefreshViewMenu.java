 ...
 */
public class SpecializationRefreshViewMenu extends ExtensionContributionFactory {
    private static final SpecializationLogger logger = new SpecializationLogger(SpecializationRefreshViewMenu.class);
        ...
        if (window != null)
        {
            ...
            if ( selection.size() != 0 ) {
                ...
                if ( selectedObject != null ) {
                    ...
                    // if the selected object is in a view, we add a menu to refresh the view label
                    if ( selectedObject != null ) {
                        IDiagramModel selectedView  = (IDiagramModel)selectedObject;
                        
                        String menuLabel = "Refresh view \"" + selectedView.getName() + "\"";
                        ...
                        additions.addContributionItem(new CommandContributionItem(new CommandContributionItemParameter(
                                ...
                                "org.archicontribs.specialization.menu.SpecializationRefreshViewMenu",      // id
