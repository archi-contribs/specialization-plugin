...
public abstract class AbstractArchimatePropertySection extends AbstractPropertySection {
    ...
    public static abstract class ObjectFilter implements IFilter {
         ...
         */
        public static boolean shouldExposeFeature(EObject eObject, EAttribute feature) {
    ...
    protected PropertySectionTextControl createNameControl(Composite parent, String hint) {
        // Label
        Label label = createLabel(parent, /*Messages.AbstractArchimatePropertySection_0*/"Name:", ITabbedLayoutConstants.STANDARD_LABEL_WIDTH, SWT.CENTER);
        ...
        PropertySectionTextControl textName = new PropertySectionTextControl(textControl, IArchimatePackage.Literals.NAMEABLE__NAME) {
            ...
            protected void textChanged(String oldText, String newText) {
                if(isAlive()) {
                    ...
                    getCommandStack().execute(new EObjectFeatureCommand(/*Messages.AbstractArchimatePropertySection_1*/ "Rename" + " " + oldText, getEObject(), //$NON-NLS-1$
    ...
    protected PropertySectionTextControl createDocumentationControl(Composite parent, String hint) {
        // Label
        Label label = createLabel(parent, /*Messages.AbstractArchimatePropertySection_2*/"Documentation:", ITabbedLayoutConstants.STANDARD_LABEL_WIDTH, SWT.NONE);
        ...
        PropertySectionTextControl textDoc = new PropertySectionTextControl(styledTextControl.getControl(), IArchimatePackage.Literals.DOCUMENTABLE__DOCUMENTATION) {
            ...
            protected void textChanged(String oldText, String newText) {
                if(isAlive()) {
                    AbstractArchimatePropertySection.this.fIsExecutingCommand = true;
                    getCommandStack().execute(new EObjectFeatureCommand(/*Messages.AbstractArchimatePropertySection_3*/ "Change Documentation", getEObject(),
     ...
     */
    protected static StyledTextControl createStyledTextControl(Composite parent, int style) {
     ...
     */
    protected static Composite createTableComposite(Composite parent, int style) {
