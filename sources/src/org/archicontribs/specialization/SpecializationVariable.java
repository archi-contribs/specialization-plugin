            ...
            default :
                ...
                if ( variableName.toLowerCase().startsWith("view"+variableSeparator) ) {
                    ...
                    if ( eObject instanceof IDiagramModelArchimateConnection ) {
                        if ( logger.isTraceEnabled() ) logger.trace("            --> "+SpecializationPlugin.getDebugName(((IDiagramModelArchimateConnection)eObject).getDiagramModel()));
                        return ((IDiagramModelArchimateConnection)eObject).getDiagramModel();
                    }
        ...
        switch ( variableName.toLowerCase() ) {
            ...
            default :
                ...
                if ( variableName.toLowerCase().startsWith("view"+variableSeparator) ) {
                    ...
                    if ( eObject instanceof IDiagramModelArchimateConnection ) {
                        return getVariable("${"+variableName.substring(4+variableSeparator.length())+"}", ((IDiagramModelArchimateConnection)eObject).getDiagramModel());
                    }
