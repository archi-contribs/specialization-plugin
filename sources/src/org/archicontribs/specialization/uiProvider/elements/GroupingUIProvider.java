...
public class GroupingUIProvider extends com.archimatetool.editor.ui.factory.elements.GroupingUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(GroupingUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our GroupingFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.GroupingFigure.class);
    }
