 ...
 * @author Herve Jouin
 */
public class ApplicationInteractionUIProvider extends com.archimatetool.editor.ui.factory.elements.ApplicationInteractionUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(ApplicationInteractionUIProvider.class);
