...
/**
 * TechnologyInteraction UI Provider
 * 
 * @author Herve Jouin
 */
public class TechnologyInteractionUIProvider extends com.archimatetool.editor.ui.factory.elements.TechnologyInteractionUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(TechnologyInteractionUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our TechnologyInteractionFigure class to be called
