...
public class ConstraintUIProvider extends com.archimatetool.editor.ui.factory.elements.ConstraintUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(ConstraintUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our ConstraintFigure class to be called
