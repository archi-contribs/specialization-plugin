 ...
 * @author Herve Jouin
 */
public class BusinessInterfaceUIProvider extends com.archimatetool.editor.ui.factory.elements.BusinessInterfaceUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(BusinessInterfaceUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our InterfaceFigure class to be called
