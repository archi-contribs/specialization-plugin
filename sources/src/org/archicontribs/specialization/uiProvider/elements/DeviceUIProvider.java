...
public class DeviceUIProvider extends com.archimatetool.editor.ui.factory.elements.DeviceUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(DeviceUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our DeviceFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.DeviceFigure.class);
    }
