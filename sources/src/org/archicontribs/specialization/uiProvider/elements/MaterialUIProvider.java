...
public class MaterialUIProvider extends com.archimatetool.editor.ui.factory.elements.MaterialUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(MaterialUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our MaterialFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.MaterialFigure.class);
    }
