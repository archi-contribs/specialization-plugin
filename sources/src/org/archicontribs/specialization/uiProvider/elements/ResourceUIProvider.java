...
public class ResourceUIProvider extends com.archimatetool.editor.ui.factory.elements.ResourceUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(ResourceUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our ResourceFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.ResourceFigure.class);
    }
