...
public class BusinessRoleUIProvider extends com.archimatetool.editor.ui.factory.elements.BusinessRoleUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(BusinessRoleUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our BusinessRoleFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.BusinessRoleFigure.class);
    }
