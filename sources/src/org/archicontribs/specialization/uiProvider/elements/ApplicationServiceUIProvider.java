...
public class ApplicationServiceUIProvider extends com.archimatetool.editor.ui.factory.elements.ApplicationServiceUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(ApplicationServiceUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our ServiceFigure class to be called
