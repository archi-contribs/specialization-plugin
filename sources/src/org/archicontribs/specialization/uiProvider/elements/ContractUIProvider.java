...
public class ContractUIProvider extends com.archimatetool.editor.ui.factory.elements.ContractUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(ContractUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our ContractFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.ContractFigure.class);
    }
