...
public class DeliverableUIProvider extends com.archimatetool.editor.ui.factory.elements.DeliverableUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(DeliverableUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our DeliverableFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.DeliverableFigure.class);
    }
