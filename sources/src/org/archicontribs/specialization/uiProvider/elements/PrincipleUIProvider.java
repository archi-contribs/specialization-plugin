...
public class PrincipleUIProvider extends com.archimatetool.editor.ui.factory.elements.PrincipleUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(PrincipleUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our PrincipleFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.PrincipleFigure.class);
    }
