...
public class CapabilityUIProvider extends com.archimatetool.editor.ui.factory.elements.CapabilityUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(CapabilityUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our CapabilityFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.CapabilityFigure.class);
    }
