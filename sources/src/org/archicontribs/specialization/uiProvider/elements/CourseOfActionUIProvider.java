...
public class CourseOfActionUIProvider extends com.archimatetool.editor.ui.factory.elements.CourseOfActionUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(CourseOfActionUIProvider.class);

    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our CourseOfActionFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.CourseOfActionFigure.class);
    }
