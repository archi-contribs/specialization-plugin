...
public class GoalUIProvider extends com.archimatetool.editor.ui.factory.elements.GoalUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(GoalUIProvider.class);
    
    @Override
    public EditPart createEditPart() {
            // we override the standard method because we want our GoalFigure class to be called
        return new ArchimateElementEditPart(org.archicontribs.specialization.uiProvider.elements.figures.GoalFigure.class);
    }
