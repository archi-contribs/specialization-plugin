...
/**
 * TechnologyProcess UI Provider
 * 
 * @author Herve Jouin
 */
public class TechnologyProcessUIProvider extends com.archimatetool.editor.ui.factory.elements.TechnologyProcessUIProvider {
    private static final SpecializationLogger logger = new SpecializationLogger(TechnologyProcessUIProvider.class);
